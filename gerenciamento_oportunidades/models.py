...
class ConteudoApresentacaoOportunidades(models.Model):
    ...
    imagem = models.ImageField(upload_to='oportunidades/apresentacao/', blank=True, null=True, verbose_name="Arquivo de Imagem")
    ...
    def save(self, *args, **kwargs):
        if self.em_exibicao:
            ConteudoApresentacaoOportunidades.objects.filter(em_exibicao=True).update(em_exibicao=False)
