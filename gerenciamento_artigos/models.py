...
class Artigo(models.Model):
    # ... (mantenha as CHOICES como estão)
    CATEGORIA_CHOICES = (
    ...
    # ... (mantenha os outros campos até 'status')
    ...
    # --- NOVOS CAMPOS DE SEO ADICIONADOS ABAIXO ---
    ...
    def clean(self): # ... (mantenha o método clean)
        super().clean()
    ...
    def save(self, *args, **kwargs): # ... (mantenha o método save)
        if not self.slug:
            self.slug = slugify(self.titulo)
        super().save(*args, **kwargs)

    def __str__(self): # ... (mantenha o método __str__)
        return self.titulo

    class Meta: # ... (mantenha a classe Meta)
        verbose_name = "Artigo"
