    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('grupo', models.CharField(choices=[('NATUREZA', 'Belezas da Natureza'), ('CULTURA', 'Cultura e Tradições')], help_text='Associe esta categoria a uma das grandes áreas do módulo.', max_length=10, verbose_name='Grupo')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imagem', models.ImageField(blank=True, null=True, upload_to='destino/apresentacao/', verbose_name='Arquivo de Imagem')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categoria', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='gerenciamento_destino.categoria', verbose_name='Categoria')),
            ],
            options={
