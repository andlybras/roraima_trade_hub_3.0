...
class ConteudoApresentacaoDestino(models.Model):
    ...
    def save(self, *args, **kwargs):
        if self.em_exibicao:
            ConteudoApresentacaoDestino.objects.filter(em_exibicao=True).update(em_exibicao=False)
    ...
    class Meta:
        verbose_name = "Conteúdo de Apresentação (Destino)"
        verbose_name_plural = "5. Conteúdos de Apresentação (Destino)"