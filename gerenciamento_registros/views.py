...
# View genérica para o processo de registro
class BaseRegisterView(CreateView):
    ...
    def form_valid(self, form):
        ...
        user.is_active = False # Desativa a conta até a confirmação por e-mail
        user.save()
...
# View específica para Empresas/Empreendedores
...
# View específica para Aprendizes
...
def activate(request, uidb64, token):
    ...
    if user is not None and account_activation_token.check_token(user, token):
        ...
        # Redireciona para uma página de link inválido
