    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_usuario', models.CharField(choices=[('ADMIN', [('PERMISSIONARIO', 'Permissionário (Equipe Interna)')]), ('EMPRESARIAL', [('EMPRESA', 'Empresa'), ('EMPREENDEDOR', 'Empreendedor')]), ('EDUCACIONAL', [('APRENDIZ', 'Aprendiz (Aprenda Comex)')])], max_length=20, verbose_name='Tipo de Usuário')),
